...
> [!IMPORTANT]
> This project is not affiliated with Stormworks, Geometa, or its developers.
...
- Microcontroller simulation support
 - [ ] GUI (In progress)
  - [ ] Simulate screen and touch
  - [ ] Input/output UI
 - [ ] Lua script runner
  - [ ] Expose draw and input/output functions
# Planned features
- Live in-game debugging
- Addon support
- Component mod support
